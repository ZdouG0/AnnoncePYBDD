...
def main() :
    ...
    if repfiltre == 'y' or repfiltre=='Y':
        ...
        if repcreate == 'y' or repcreate=='Y':
            ...
            repBack = input("Voulez vous relancer l'application ? [Y/N]")
            RepOk=False
            while RepOk ==False:
    ...
    for annonce in result :
        ...
        if (ConnectionOK==True) :
            repMakeOffer = input("Voulez vous faire une offre ? [Y/N]")
            RepOk=False
            while RepOk ==False:
                
                if repMakeOffer != 'Y' and repMakeOffer != 'N' and repMakeOffer != 'y' and repMakeOffer != 'n':
                    repMakeOffer = input("Entree incorrect ! Veuillez reesayer :")
                else :
                    RepOk = True
            if repMakeOffer == 'y' or repMakeOffer=='Y':
                Utilisateur.makeoffer(idannonce)
